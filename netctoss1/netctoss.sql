select * from cost_yf 
select * from ADMIN_INFO_yf
update cost_yf set startime=null;
create sequence admin_seq_yf start with 1;
select * from cost_yf order by cost_id


update cost_yf set cost_type='2' where cost_id in (1,2,3,4);
update cost_yf set cost_type='3' where cost_id=5;
update cost_yf set cost_type='1' where cost_id=6;
commit;
--建表时，表名+后缀，主键约束名+后缀
--资费信息表
create table cost_yf(
  	cost_id			number(4) constraint cost_id_pk_yf primary key,
...
--创建的序列名+后缀
create sequence cost_seq_yf start with 100;

INSERT INTO COST_YF VALUES (1,'5.9元套餐',20,5.9,0.4,0,'5.9元20小时/月,超出部分0.4元/时',DEFAULT,DEFAULT,NULL);
INSERT INTO COST_YF VALUES (2,'6.9元套餐',40,6.9,0.3,0,'6.9元40小时/月,超出部分0.3元/时',DEFAULT,DEFAULT,NULL);
INSERT INTO COST_YF VALUES (3,'8.5元套餐',100,8.5,0.2,0,'8.5元100小时/月,超出部分0.2元/时',DEFAULT,DEFAULT,NULL);
INSERT INTO COST_YF VALUES (4,'10.5元套餐',200,10.5,0.1,0,'10.5元200小时/月,超出部分0.1元/时',DEFAULT,DEFAULT,NULL);
INSERT INTO COST_YF VALUES (5,'计时收费',null,null,0.5,0,'0.5元/时,不使用不收费',DEFAULT,DEFAULT,NULL);
INSERT INTO COST_YF VALUES (6,'包月',null,20,null,0,'每月2000元,不限制使用时间',DEFAULT,DEFAULT,NULL);
COMMIT;
...
commit;
--管理员表
insert into admin_info_yf values(2000,'admin','123','ADMIN','123456789','admin@tarena.com.cn',sysdate);
insert into admin_info_yf values(3000,'zhangfei','123','ZhangFei','123456789','zhangfei@tarena.com.cn',sysdate);
insert into admin_info_yf values(4000,'liubei','123','LiuBei','123456789','liubei@tarena.com.cn',sysdate);
insert into admin_info_yf values(5000,'caocao','123','CaoCao','123456789','caocao@tarena.com.cn',sysdate);
insert into admin_info_yf values(6000,'aaa','123','AAA','123456789','aaa@tarena.com.cn',sysdate);
insert into admin_info_yf values(7000,'bbb','123','BBB','123456789','bbb@tarena.com.cn',sysdate);
commit;
--管理员角色表
