                ...
                <div id="data">            
                    <table id="datalist">
                        <tr>
                         ...
                         <!-- 使用JSTL循环数据，使用EL获取数据。 -->
                         <!-- items用来指定要循环的数据，该数据通常需要使用EL获取。 -->
                         <!-- c是每次循环所对应数据(Cost)的名字 -->
                         <c:forEach items="${cost }" var="c">
                        	<tr>
                            	...
                            	<td>${c.baseCost }</td>
                            	<td>${c.unitCost }</td>
                            	<td><fmt:formatDate value="${c.creatime }" pattern="yyyy-MM-dd HH:mm:ss E a"/></td>
                            	<td><fmt:formatDate value="${c.startime }" pattern="yyyy-MM-dd HH:mm:ss E a"/></td>
                            	<td>
